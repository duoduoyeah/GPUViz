...
describe('GraphCore', () => {
  ...
  describe('Data Updates', () => {
    const testGraph: Graph = {
      nodes: [{ data: { id: 'n1', label: 'Node 1', shape: 'square', type: 'test' } }],
    ...
    it('should update the graph with new data', () => {
      ...
      expect(mockCytoscapeInstance.add).toHaveBeenCalledWith([
        { data: { id: 'n1', label: 'Node 1', shape: 'square', type: 'test' } },
  ...
  describe('Layout Application', () => {
    ...
    it('should apply a specified layout', () => {
      ...
      expect(mockCytoscapeInstance.layout).toHaveBeenCalledWith(LAYOUT_PRESETS.circle);
