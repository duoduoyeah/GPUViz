...
describe('GraphEvents', () => {
  ...
  describe('Initialization and Cleanup', () => {
    ...
    it('should set a new cytoscape instance', () => {
      const newCy = { ...mockCytoscapeInstance, on: jest.fn() } as unknown as cytoscape.Core;
  ...
  describe('Cytoscape Event Bridging', () => {
    ...
    it('should emit `nodeClick` on node tap', () => {
        ...
        const nodeTapCallback = (cy.on as jest.Mock).mock.calls.find(call => call[0] === 'tap' && call[1] === 'node')[2];
